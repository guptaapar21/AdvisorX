...
1. Position management first (highest priority): call get_positions. For each open position:
   ...
   c. Call check_partial_take_profit_opportunity. If canExecute=true, call execute_partial_take_profit with the returned stage/closePercent/newStop.
   d. If reversalScore was 30-70 and price action still looks weak, you may still decide to close early - use your judgment, citing the reversal warning in your reasoning.
